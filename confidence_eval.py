...
parser.add_argument('--protein_ligand_csv', type=str, default='/home/dj/diffdock/DiffDock-main/data/protein_ligand_example_csv.csv', help='Path to a .csv file specifying the input as described in the README. If this is not None, it will be used instead of the --protein_path, --protein_sequence and --ligand parameters')
...
if args.confidence_model_dir is not None:
    confidence_model = get_model(confidence_args, device, t_to_sigma=[0,0,0], no_parallel=True, confidence_mode=True)
...
for idx, orig_complex_graph in tqdm(enumerate(test_loader)):
    try:
        ...
        if confidence is not None:
            ...
            print(confidence)
            confidence_result[confidence_test_dataset.ligand_descriptions[idx]]=sigmoid(confidence)
        ...
        print("Failed on",complex_name_list[idx] , e)
        failures += 1
